...
import {
  IDefaultEditorConfig,
  IOrgEditorConfig,
  IMindmapEditorConfig,
  IDiagramEditor,
  DiagramEditorEvents,
  IDiagramEditorHandlersMap,
  IEditorConfig,
  HistoryManager,
} from "../../ts-diagram-editor";
import {
  Editbar,
  Toolbar,
  View as Views,
} from "../../ts-diagram-editor/sources/view";
...
export declare class DiagramEditor extends View implements IDiagramEditor {
  ...
  config:
    ...
    | IEditorConfig;
  events: IEventSystem<
    DataEvents | SelectionEvents | DiagramEvents | DiagramEditorEvents,
    IDiagramEditorHandlersMap
  >;
  view: Views;
  toolbar: Toolbar;
  ...
  constructor(
    ...
    config?: IDefaultEditorConfig | IOrgEditorConfig | IMindmapEditorConfig
  );
  paint(): void;
  destructor(): void;
